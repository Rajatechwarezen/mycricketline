...
import 'package:sprotbuzz/view/component/text/label_text.dart';


class CustomAmountTextField extends StatefulWidget {

  const CustomAmountTextField(BuildContext context, {
    Key? key,
          ...
          child: Row(
            ...
            children: [
                  ...
                  child: Focus(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          hintStyle: interRegularSmall.copyWith(color: MyColor.myhintTextColor, height: 1.452),
              ...
              Container(
                ...
                child: Text(widget.currency, textAlign: TextAlign.center, style: interRegularDefault.copyWith(color: MyColor.getPrimaryColor(), fontWeight: FontWeight.w500)),
              )
            ],
          ),
        ),
