...
class ScoreTable extends StatefulWidget {
  ...
  ScoreTable( {super.key,this.idMatch,});
...
ScoreTableController? myscore = ScoreTableController(scoreTableRepo: ScoreTableRepo(apiClient: Get.find()));
...
//////////////////////////
 ...
 return MyListData == null  &&  MyListData == "" ?
 const CustomDivider() :
            ...
            children: [
              DataTable(
                ...
                columns: [
                  DataColumn(
                    label: SizedBox(
                      width: 130,
                      child: Text('Batman',
                          style: interBoldDefault.copyWith(color: MyColor.myGolden())),
                    ),
                  ),
                  DataColumn(
                    label: Text('R',
                ...
                rows: MyListData!.map((batsman) {
                  return DataRow(
                    cells: [
                      DataCell(Text(batsman.name ?? "", style: interBoldSmall.copyWith(color: MyColor.getTextColor()))),
                      DataCell(Text(batsman.run.toString(), style: interBoldSmall.copyWith(color: MyColor.getTextColor()))),
                      DataCell(Text(batsman.ball.toString(), style: interBoldSmall.copyWith(color: MyColor.getTextColor()))),
                      DataCell(Text(batsman.fours.toString(), style: interBoldSmall.copyWith(color: MyColor.getTextColor()))),
                      DataCell(Text(batsman.sixes.toString(), style: interBoldSmall.copyWith(color: MyColor.getTextColor()))),
                      DataCell(Text(batsman.strikeRate.toString(), style: interBoldSmall.copyWith(color: MyColor.getTextColor()))),
                    ],
                  );
                }).toList(),
              ),
              DataTable(
                ...
                rows: MyListDataBol!.map((bowler) {
                  return DataRow(
                    color: MaterialStateProperty.resolveWith( (states) => MyColor.getBottomNavBg()),
                    cells: [
                      DataCell(Text(bowler.name,style: interBoldSmall.copyWith(color: MyColor.getTextColor()))),
                      DataCell(Text(bowler.run.toString(), style: interBoldSmall.copyWith(color: MyColor.getTextColor()))),
                      DataCell(Text(bowler.over.toString(), style: interBoldSmall.copyWith(color: MyColor.getTextColor()))),
                      DataCell(Text(bowler.maiden.toString(), style: interBoldSmall.copyWith(color: MyColor.getTextColor()))),
                      DataCell(Text(bowler.wicket.toString(), style: interBoldSmall.copyWith(color: MyColor.getTextColor()))),
                      DataCell(Text(bowler.economy.toString(), style: interBoldSmall.copyWith(color: MyColor.getTextColor()))),
                      DataCell(Text(bowler.dotBall.toString(), style: interBoldSmall.copyWith(color: MyColor.getTextColor()))),
                    ],
                  );
                }).toList(),
              ),
