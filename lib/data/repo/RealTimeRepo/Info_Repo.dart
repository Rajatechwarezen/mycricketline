...
import '../../model/vanue/vanue_model.dart';
...
Future getvanueData(id) async {

    String apiUrl = UrlContainer.inofvanueIdhUrl;
...
print(response!.responseJson);
  ...
  if (response != null && response.isSuccess) {
      ...
      if (liveMatchJsonDecode['status'] == true) {
          if (liveMatchJsonDecode['data'] is List) {
              List<VenueData> matches = (liveMatchJsonDecode['data'] as List)
                  .map((json) => VenueData.fromJson(json))
                  .toList();
